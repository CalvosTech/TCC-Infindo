                   ...
                   <!-- ***** Produtos 7 começo ***** -->
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4>Caneca porcelana branca flork</h4>
                                <span>R$ 35,00</span>
                                <ul class="stars">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4>Caneca porcelana branca, "Casa comigo?"</h4>
                                <span>R$ 35,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4>Caneca porcelana branca, Mickey e Minie</h4>
                                <span>R$ 35,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4>Caneca porcelana glitter e alsa rosa, Barbie</h4>
                                <span>R$ 55,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4>CCaneca porcelana branca, Barbie</h4>
                                <span>R$ 55,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4>CCaneca porcelana glitter e alsa rosa, Barbie</h4>
                                <span>R$ 55,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
