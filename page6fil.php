                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4> <a href="single_products/single-product.php">Camiseta básica macia unissex </a></h4>
                                <h5>Estampável</h5>
                                <span>R$ 40,00</span>
                                <ul class="stars">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4><a href="single_products/single-product2.php">Camiseta modelagem reta masculina</a></h4>
                                <h5>Estampável</h5>
                                <span>R$ 40,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4><a href="single_products/single-product3.php">Camiseta tri-blend unissex</a></h4>
                                <h5>Estampável</h5>
                                <span>R$ 45,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
