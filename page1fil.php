...
-->
                                    ...
                                    <div class="cart-mainf">
                                        <div class="hubcart hubcart2 cart cart box_1">
                                            <form action="#" method="post">
                                                ...
                                                <button class="btn top_hub_cart mt-1" type="submit" name="submit" value="" title="Cart" style="
    ...
    if ($(event.target).is('.cd-signin')) {
        ...
        <section class="section" id="products">
            ...
            <div class="filtro">
                <div class="dropdown" id="tamanhoDropdown">
                    <div class="dropdown-box">
                        <div class="tamanho-label">
                            Todos os produtos
                        </div>
                    </div>
                    <div class="opcoes" id="opcoesTamanho" style="z-index: 999;">
                        <a href="page1fil.php" class="opcao">Pre-Estampadas</a>
                        <a href="page2fil.php" class="opcao">Estampáveis</a>
                        <a href="page3fil.php" class="opcao">Canecas</a>
                        <a href="page4fil.php" class="opcao">Canecas Pre-Estampadas</a>
                        <a href="page5fil.php" class="opcao">Canecas Estampáveis</a>
                        <a href="page6fil.php" class="opcao">Camisetas</a>
                        <a href="page8fil.php" class="opcao">Camisetas Estampáveis</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <!-- <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4>Camiseta básica macia unissex</h4>
                                <h5>Estampável</h5>
                                <span>R$ 40,00.00.00</span>
                                <ul class="stars">
                    ...
                    <!-- <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb"> -->
                                ...
                                <!-- <img src="assets/images/camiseta_reta.jpg" alt>
                            </div>
                            <div class="down-content">
                                <h4>Camiseta modelagem reta masculina</h4>
                                <h5>Estampável</h5>
                                <span>R$ 40,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <!-- <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb"> -->
                                ...
                                <!-- <img src="imagens/trimenor.png" alt>
                            </div>
                            <div class="down-content">
                                <h4>Suéter fleece unissex</h4>
                                <h5>Estampável</h5>
                                <span>R$ 45,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <!-- <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="assets/images/porcelana.png" alt>
                            </div>
                            <div class="down-content">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="imagens/caneca_abrigo1.jpg" alt>
                            </div>
                            <div class="down-content">
                                <h4><a href="single_products/single-product7.php">Caneca porcelana branca flork</a></h4>
                                <span>R$ 35,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="imagens/caneca_casa_comigo_2.jpg" alt>
                            </div>
                            <div class="down-content">
                                <h4><a href="single_products/single-product8.php">Caneca porcelana branca, "Casa comigo?"</a></h4>
                                <span>R$ 35,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="imagens/caneca_mickey3.jpg" alt>
                            </div>
                            <div class="down-content">
                                <h4><a href="single_products/single-product9.php">Caneca porcelana branca, Mickey e Minie</a></h4>
                                <span>R$ 35,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="imagens/barbie1.jpg" alt>
                            </div>
                            <div class="down-content">
                                <h4><a href="single_products/single-product10.php">Caneca porcelana glitter e alsa rosa, Barbie</a></h4>
                                <span>R$ 55,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="imagens/barbie2.jpg" alt>
                            </div>
                            <div class="down-content">
                                <h4><a href="single_products/single-product11.php">Caneca porcelana branca, Barbie</a></h4>
                                <span>R$ 55,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            <div class="thumb">
                                ...
                                <img src="imagens/barbie3.jpg" alt>
                            </div>
                            <div class="down-content">
                                <h4><a href="single_products/single-product12.php">Caneca porcelana glitter e alsa rosa, Barbie</a></h4>
                                <span>R$ 55,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="Paginador">
                        <button id="button1" onclick="changePage(1)">1</button>
                        <button id="button2" onclick="changePage(2)" >2</button>
                      </div>
			...
			<li><a href="#">Canecas</a></li> -->
                    ...
                    <script src="script_filtro.js" defer></script>
                    <script src="scriptpaginador.js" defer></script>
