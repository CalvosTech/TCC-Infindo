                        ...
                        ?>
                                <li class="scroll-to-section">
                                    <div class="cart-mainf">
                                        <div
                                            class="hubcart hubcart2 cart cart box_1">
                                            <form action="#" method="post">
                                                ...
                                                <button
                                                    class="btn top_hub_cart mt-1"
                                                    type="submit" name="submit"
                                                    value title="Cart" style="
            ...
            <div class="filtro">
                <div class="dropdown" id="tamanhoDropdown">
                    ...
                    <div class="opcoes" id="opcoesTamanho" style="z-index: 999;">
                        ...
                        <a href="page4fil.php" class="opcao">Canecas
                            Pre-Estampadas</a>
                        <a href="page5fil.php" class="opcao">Canecas
                            Estampáveis</a>
                        <a href="page6fil.php" class="opcao">Camisetas</a>
                        <a href="page7fil.php" class="opcao">Camisetas
                            Pre-Estampadas</a>
                        <a href="page8fil.php" class="opcao">Camisetas
                            Estampáveis</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4> <a
                                        href="single_products/single-product.php">Camiseta
                                        básica macia unissex </a></h4>
                                <h5>Estampável</h5>
                                <span>R$ 40,00</span>
                                <ul class="stars">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4><a
                                        href="single_products/single-product2.php">Camiseta
                                        modelagem reta masculina</a></h4>
                                <h5>Estampável</h5>
                                <span>R$ 40,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4><a
                                        href="single_products/single-product3.php">Camiseta tri-blend unissex</a></h4>
                                <h5>Estampável</h5>
                                <span>R$ 45,00</span>
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4><a
                                        href="single_products/single-product4.php">Caneca
                                        de cerâmica</a></h4>
                                <h5>Estampável</h5>
                                <span>R$ 35,00</span>
                                <ul class="stars">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4><a
                                        href="single_products/single-product5.php">Caneca
                                        de porcelana</a></h4>
                                <h5>Estampável</h5>
                                <span>R$ 35,00</span>
                                <ul class="stars">
                    ...
                    <div class="col-lg-4">
                        <div class="item">
                            ...
                            <div class="down-content">
                                <h4><a
                                        href="single_products/single-product6.php">Caneca
                                        de plastico</a></h4>
                                <h5>Estampável</h5>
                                <span>R$ 35,00</span>
                                <ul class="stars">
